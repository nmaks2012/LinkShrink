...
prometheus::Counter* linkshrink_urls_created_total = nullptr;
prometheus::Counter* linkshrink_redirects_total = nullptr;
prometheus::Histogram* linkshrink_db_latency = nullptr;
